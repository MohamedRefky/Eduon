...
class CourseDetailsCubit extends Cubit<CourseDetailsState> {
  ...
  Future<void> loadPlaylistVideos() async {
    ...
    try {
      ...
      if (playlistId.startsWith('subject_')) {
        final videoId = playlistId.replaceFirst('subject_', '');
        playlist = await _repository.getSingleVideoAsPlaylist(videoId);
      } else {
        playlist = await _repository.getPlaylistWithVideos(playlistId);
      }
