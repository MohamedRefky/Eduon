...
class _EditProfileDialogState extends State<EditProfileDialog> {
  ...
  void initState() {
    ...
    imagePath = PrefrancesManeger().getUserImage(uid);
  ...
  Future<void> pickImage(ImageSource source) async {
    try {
      ...
      await PrefrancesManeger().setUserImage(uid, file.path);
  ...
  Widget buildAvatar() {
    final file = selectedImage ?? initialImage;
            ...
            children: [
              ListTile(
                ...
                title: Text(
                  ...
                  style: TextTheme.of(
                    context,
                  ).displayMedium?.copyWith(fontSize: AppSizes.sp18),
                ),
                onTap: () {
                  Navigator.pop(context);
