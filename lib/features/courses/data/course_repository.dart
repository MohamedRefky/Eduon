...
class CourseRepository {
  ...
  // =========================
  // =========================
  // GET SINGLE VIDEO AS PLAYLIST
  // =========================
  Future<PlaylistModel> getSingleVideoAsPlaylist(String videoId) async {
    final details = await _apiService.getVideosDetails([
      VideoModel(
        videoId: videoId,
        title: '',
        thumbnailUrl: '',
    ...
    if (details.isEmpty) throw Exception('Video not found');

    final video = details.first;

    return PlaylistModel(
      playlistId: 'subject_$videoId',
      title: video.title,
      description: '',
