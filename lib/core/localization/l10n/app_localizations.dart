...
abstract class AppLocalizations {
  ...
  /// No description provided for @academic_subjects.
  ///
  /// In en, this message translates to:
  /// **'Academic Subjects'**
  String get academic_subjects;

  /// No description provided for @non_academic_subjects.
  ///
  /// In en, this message translates to:
  /// **'Non-Academic Subjects'**
  String get non_academic_subjects;

  /// No description provided for @open_in_youtube_tooltip.
  ///
  /// In en, this message translates to:
  /// **'Open in YouTube'**
  String get open_in_youtube_tooltip;

  /// No description provided for @year_changed.
  ///
  /// In en, this message translates to:
  /// **'Academic year updated successfully!'**
  String get year_changed;
}
